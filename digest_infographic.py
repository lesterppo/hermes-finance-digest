...
def videos_notebook_context(items: list[dict], date_label: str = "") -> str:
    ...
    return (
        ...
        "(繁體中文). Never render a Chinese title, concept or takeaway in "
        "English — no 'BlackRock View', no 'One-Hammer Tone' — and do not "
        "translate the Chinese headlines at all. The only Latin text allowed is "
        ...
        "ticker alone. 所有可見文字必須為繁體中文；不得出現英文句子或中文標題的英文翻譯。\n"
