...
請用繁體中文（香港）撰寫一份專業日報，格式為 Markdown，直接由「## 市場總覽」開始，
無客套話、無開場白、無結語。

## 市場總覽
三大指數表現、市場寬度/波動率、一句話總結當日主調（≤60字）。

## 關鍵水平（新增，必填）
用表格列出以下有數據者（代號｜名稱｜收市｜變動；利率用 bp）：
S&P 500、納斯達克、道瓊、羅素2000、VIX、美債10/30/5年、WTI、布蘭特、黃金、白銀、銅、
美元指數、美元/日圓、歐元/美元、比特幣、日經、恒生、KOSPI、DAX、CAC、上證。
缺數據寫「—」，不要省略該行。

## 核心事件
當日最重要的 2–4 個事件，每個 2–3 句。只可基於上面標題所反映的事件；
如標題不足以支撐，明確寫「標題未提供細節」。每個事件標註【相關頭條：媒體＋關鍵詞】。

## 七巨頭與產業
逐一列出七巨頭當日表現（代號｜收市｜變動），指出拖累與逆市贏家（各最多2家），一句理由。

## 利率、債市與商品
美債 10/30/5 年（bp）、原油、黃金、銅，用精確表述；一句話說明利率/商品對股市的傳導。

## 亞歐市場
日經、恒生、KOSPI、DAX、CAC、上證；與美股對比一句話（亞強歐弱 / 同步 / 背離）。

## 後市觀察
只寫附帶明確催化劑＋日期的前瞻（≤3條，格式：事件｜日期｜觀察指標）。
沒有明確催化劑就寫「暫無明確催化劑」，不要寫推測性段落。通用市場觀察如要寫，
必須標明（推測）並限一句。
